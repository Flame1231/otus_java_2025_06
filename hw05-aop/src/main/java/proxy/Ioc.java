...
public class Ioc {
    ...
    public static TestLoggingInterface createMyClass() {
        if (Objects.isNull(testLoggingProxy)) {
            ...
            testLoggingProxy = (TestLoggingInterface) Proxy.newProxyInstance(
                    original.getClass().getClassLoader(), original.getClass().getInterfaces(), handler);
        }
    ...
    private static class LogInvocationHandler implements InvocationHandler {
        ...
        public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
            if (methodsWithAnnotation.contains(method.getName() + Arrays.toString(method.getParameterTypes()))) {
                ...
                Arrays.stream(args).forEach(arg -> System.out.print(arg.toString() + " "));
                System.out.println();
            }
